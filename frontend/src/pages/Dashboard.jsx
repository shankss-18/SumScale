  ...
  return (
    <div className="min-h-screen bg-[#EDF6F9] text-slate-800 flex flex-col font-sans antialiased sarvam-gradient-bg">
      ...
      <main className="flex-1 max-w-6xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {/* ── Previous Conversations — Horizontal Timeline Ribbon ── */}
        {savedChats.length > 0 && (
          <div className="bg-white rounded-3xl border border-[#83C5BE]/40 shadow-sm p-7 space-y-5 relative overflow-hidden">
            <div className="absolute top-0 right-0 w-48 h-32 bg-gradient-to-bl from-[#EDF6F9] to-transparent pointer-events-none rounded-3xl" />

            <div className="flex items-center justify-between relative z-10">
              <div>
                <p className="text-[10px] font-extrabold uppercase tracking-widest text-[#006D77]">Copilot History</p>
                <h2 className="text-lg font-extrabold text-slate-900 mt-0.5">Recent Conversations</h2>
              </div>
              <span className="px-3 py-1 rounded-full bg-[#EDF6F9] border border-[#83C5BE]/50 text-xs font-bold text-[#006D77]">
                {savedChats.length} queries
              </span>
            </div>

            {/* Horizontal scrollable timeline */}
            <div className="relative z-10 overflow-x-auto pb-4 -mx-1 px-1">
              {/* Connecting line */}
              <div className="absolute top-[52px] left-0 right-0 h-px bg-gradient-to-r from-transparent via-[#83C5BE]/50 to-transparent pointer-events-none" />

              <div className="flex items-start gap-0 min-w-max">
                {savedChats.slice(-10).map((chat, idx) => {
                  const colors = [
                    { bg: '#006D77', light: '#EDF6F9', text: '#006D77' },
                    { bg: '#83C5BE', light: '#f0faf9', text: '#005a63' },
                    { bg: '#005a63', light: '#e8f4f5', text: '#006D77' },
                  ];
                  ...
                  return (
                    <div
                      key={idx}
                      className="group flex flex-col items-center gap-2 px-3"
                      style={{
                    ...
                    >
                      {/* Index chip */}
                      <span
                        className="text-[9px] font-extrabold text-slate-400 uppercase tracking-widest transition-colors duration-200 group-hover:text-[#006D77]"
                      >
                        #{idx + 1}
                      </span>
                      ...
                      {/* Dot on the timeline */}
                      <div
                        className="w-3 h-3 rounded-full border-2 border-white shadow-md flex-shrink-0 transition-all duration-300 group-hover:scale-150"
                      ...
                      >
                        <div
                          ...
                          style={{
                            ...
                            borderColor: `${col.bg}30`,
                            color: '#334155',
                            maxHeight: '3.5rem',
                            overflow: 'hidden',
                            boxShadow: '0 2px 8px rgba(0,109,119,0.06)',
                          }}
                          onMouseEnter={e => {
                            e.currentTarget.style.maxHeight = '12rem';
                            e.currentTarget.style.boxShadow = `0 8px 28px ${col.bg}30`;
                            e.currentTarget.style.borderColor = `${col.bg}80`;
                            e.currentTarget.style.color = col.text;
                            e.currentTarget.style.transform = 'translateY(-4px) scale(1.02)';
                            e.currentTarget.style.zIndex = '10';
                          }}
                          onMouseLeave={e => {
                            e.currentTarget.style.maxHeight = '3.5rem';
                            e.currentTarget.style.boxShadow = '0 2px 8px rgba(0,109,119,0.06)';
                            e.currentTarget.style.borderColor = `${col.bg}30`;
                        ...
                        <div
                          ...
                          style={{
                            background: `radial-gradient(circle at 50% 0%, ${col.bg}15, transparent 70%)`,
                          }}
                        />
                      </div>
                    </div>
